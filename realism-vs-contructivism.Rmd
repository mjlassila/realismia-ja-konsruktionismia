...
png("top_topics.png", width=9,height=4, units='in', res=300)
graphics::plot(
  final_model_fit,
  type = "summary",
  xlim = c(0, .3),
...
png("topic-prevalence-vs-epistomology.png", width=7.7,height=11.1, units='in', res=300)
graphics::plot(
  prep,
...
# Aiheiden laadukkuus (semantic coherence)
